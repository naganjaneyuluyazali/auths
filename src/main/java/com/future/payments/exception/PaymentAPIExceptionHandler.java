...
@Component
public class PaymentAPIExceptionHandler extends AbstractErrorWebExceptionHandler {


    public PaymentAPIExceptionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources,
